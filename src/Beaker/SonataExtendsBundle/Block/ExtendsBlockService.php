...
namespace Beaker\SonataExtendsBundle\Block;
...
class ExtendsBlockService extends BaseBlockService
{
    ...
    {
        return 'BeakerSonataExtends';
    }

    public function setDefaultSettings(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'title'    => 'Beaker Extends Bundle',
            'template' => 'BeakerSonataExtendsBundle:Block:admin.html.twig',
        ));
    }
    
    public function execute(BlockContextInterface $blockContext, Response $response = null) 
    {
        $options = $this->container->getParameter('Beaker_sonata_extends');
