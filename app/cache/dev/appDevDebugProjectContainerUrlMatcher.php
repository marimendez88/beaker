...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Lumen\\AppBundle\\Controller\\DefaultController::indexAction',  '_locale' => 'es',  '_route' => 'index',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/sonata/user')) {
                if (0 === strpos($pathinfo, '/admin/sonata/user/user')) {
                    ...
                    if ($pathinfo === '/admin/sonata/user/user/list') {
                        return array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::listAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_list',  '_route' => 'admin_sonata_user_user_list',);
                    }

                    // admin_sonata_user_user_create
                    if ($pathinfo === '/admin/sonata/user/user/create') {
                        return array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::createAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_create',  '_route' => 'admin_sonata_user_user_create',);
                    }

                    // admin_sonata_user_user_batch
                    if ($pathinfo === '/admin/sonata/user/user/batch') {
                        return array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::batchAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_batch',  '_route' => 'admin_sonata_user_user_batch',);
                    }

                    // admin_sonata_user_user_edit
                    if (preg_match('#^/admin/sonata/user/user/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sonata_user_user_edit')), array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::editAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_edit',));
                    }

                    // admin_sonata_user_user_delete
                    if (preg_match('#^/admin/sonata/user/user/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sonata_user_user_delete')), array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::deleteAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_delete',));
                    }

                    // admin_sonata_user_user_show
                    if (preg_match('#^/admin/sonata/user/user/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_sonata_user_user_show')), array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::showAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_show',));
                    }

                    // admin_sonata_user_user_export
                    if ($pathinfo === '/admin/sonata/user/user/export') {
                        return array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\UserAdminController::exportAction',  '_sonata_admin' => 'sonata.user.admin.user',  '_sonata_name' => 'admin_sonata_user_user_export',  '_route' => 'admin_sonata_user_user_export',);
                    }
            ...
            if (0 === strpos($pathinfo, '/admin/lumen/sonataextends/fakeentity')) {
                // admin_lumen_sonataextends_fakeentity_list
                if ($pathinfo === '/admin/lumen/sonataextends/fakeentity/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_list',  '_route' => 'admin_lumen_sonataextends_fakeentity_list',);
                }

                // admin_lumen_sonataextends_fakeentity_create
                if ($pathinfo === '/admin/lumen/sonataextends/fakeentity/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_create',  '_route' => 'admin_lumen_sonataextends_fakeentity_create',);
                }

                // admin_lumen_sonataextends_fakeentity_batch
                if ($pathinfo === '/admin/lumen/sonataextends/fakeentity/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_batch',  '_route' => 'admin_lumen_sonataextends_fakeentity_batch',);
                }

                // admin_lumen_sonataextends_fakeentity_edit
                if (preg_match('#^/admin/lumen/sonataextends/fakeentity/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_lumen_sonataextends_fakeentity_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_edit',));
                }

                // admin_lumen_sonataextends_fakeentity_delete
                if (preg_match('#^/admin/lumen/sonataextends/fakeentity/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_lumen_sonataextends_fakeentity_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_delete',));
                }

                // admin_lumen_sonataextends_fakeentity_show
                if (preg_match('#^/admin/lumen/sonataextends/fakeentity/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_lumen_sonataextends_fakeentity_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_show',));
                }

                // admin_lumen_sonataextends_fakeentity_export
                if ($pathinfo === '/admin/lumen/sonataextends/fakeentity/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.lumen.extends.base',  '_sonata_name' => 'admin_lumen_sonataextends_fakeentity_export',  '_route' => 'admin_lumen_sonataextends_fakeentity_export',);
                }
